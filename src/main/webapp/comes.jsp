...
<body>
 <%--::header part start::--%>
    ...
    <section class="section-top-border">
        <div class="container">
        <h1>Forum Comment</h1>
        <table id="tbforum" style="width: 100%; margin: 0px auto;" class="text-center table table-bordered pb-5">
			<thead >
			<tr id="tr">			
			<th scope="col">Forum Question and Comment </th>
     ...
     <section class="section-top-border">
        <div class="container">
        <h1>Mesage from Contact</h1>
        <table id="tbMess" style="width: 100%; margin: 0px auto;" class="text-center table table-bordered pb-5">
			<thead >
			<tr id="tr">			
	 ...
	 <section class="section-top-border">
        <div class="container">
        <h1>Comment</h1>
        <table id="tbCom" style="width: 100%; margin: 0px auto;" class="text-center table table-bordered pb-5">
			<thead >
			<tr id="tr">			
