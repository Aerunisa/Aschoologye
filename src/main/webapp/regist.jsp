...
<head>
    ...
    <title>update Aschoologye</title>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" id="navbarDropdown"
                                        role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                         href="regist.jsp">Register</a>
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="login.jsp" id="btnLogin">Login</a>  
                                        <a class="dropdown-item" href="regist.jsp" id="btnSignUp">Join New Member</a>
                                        <a class="dropdow-item hide" id="btnLogout"> Logout</a>                                       
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <form class="form-contact2 contact_form" id="RegisForm">
            			<h3 class="mb-30 nav-link" style="color: Red">Update Account Aschoologye</h3>																						
